...
public class HPconfig {
	...
	public void draw(Graphics2D g2,int second,int minute) {
		g2.setColor(Color.red);
		g2.fillRect(10, 20, hp1, 20);
		whiteHpdraw(g2);
		drawPower1(g2);
		drawTime(g2,second,minute);
	}
	...
	public void drawTime(Graphics2D g2,int second,int minute) {
		
		g2.setColor(Color.red);
		g2.setFont(g2.getFont().deriveFont(Font.PLAIN,24));
		if(second<10) g2.drawString(minute +" : 0" +second, 620, 40);
		else g2.drawString(minute +" : " +second, 620, 40);
	}
	public int getHp1() {
		return hp1;
	}
