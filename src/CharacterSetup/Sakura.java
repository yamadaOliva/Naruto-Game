...
public class Sakura extends character {
    ...
    private void getUltimateIMG() {
    	try {
    		for(int i = 1;i<=16;i++) {
			this.ultimateSkill[i-1] = ImageIO.read(getClass().getResource("/character/" + characterName +"/ultilmate_" + Integer.toString(i) + ".png"));
    		}
		} catch (Exception e) {
			e.printStackTrace();
		}
    ...
    private void getComboIMGRight() {
        try {
            this.comboIMGRight[0] = ImageIO.read(getClass().getResource("/character/" + characterName + "/combo1.png"));
            this.comboIMGRight[1] = ImageIO.read(getClass().getResource("/character/" + characterName + "/combo2.png"));
            this.comboIMGRight[2] = ImageIO.read(getClass().getResource("/character/" + characterName + "/combo3.png"));
            this.comboIMGRight[3] = ImageIO.read(getClass().getResource("/character/" + characterName + "/combo4.png"));
            this.comboIMGRight[4] = ImageIO.read(getClass().getResource("/character/" + characterName + "/combo5.png"));
            this.comboIMGRight[5] = ImageIO.read(getClass().getResource("/character/" + characterName + "/combo6.png"));
            this.comboIMGRight[6] = ImageIO.read(getClass().getResource("/character/" + characterName + "/combo7.png"));
            this.comboIMGRight[7] = ImageIO.read(getClass().getResource("/character/" + characterName + "/combo8.png"));
            this.comboIMGRight[8] = ImageIO.read(getClass().getResource("/character/" + characterName + "/combo9.png"));
