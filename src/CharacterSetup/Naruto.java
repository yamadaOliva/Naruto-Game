	...
	private void getComboIMGRight() {
		try {
			this.comboIMGRight[0] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_1.png"));
			this.comboIMGRight[1] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_2.png"));
			this.comboIMGRight[2] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_3.png"));
			this.comboIMGRight[3] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_4.png"));
			this.comboIMGRight[4] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_5.png"));
			this.comboIMGRight[5] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_6.png"));
			this.comboIMGRight[6] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_7.png"));
			this.comboIMGRight[7] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_8.png"));
			this.comboIMGRight[8] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_9.png"));
			this.comboIMGRight[9] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_10.png"));
			this.comboIMGRight[10] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_11.png"));
			this.comboIMGRight[11] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_12.png"));
			this.comboIMGRight[12] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_13.png"));
			this.comboIMGRight[13] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combo_14.png"));
	...
	private void getComboIMGLeft() {
		try {
			this.comboIMGLeft[0] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_1 (1).png"));
			this.comboIMGLeft[1] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_2 (1).png"));
			this.comboIMGLeft[2] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_3 (1).png"));
			this.comboIMGLeft[3] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_4 (1).png"));
			this.comboIMGLeft[4] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_5 (1).png"));
			this.comboIMGLeft[5] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_6 (1).png"));
			this.comboIMGLeft[6] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_7 (1).png"));
			this.comboIMGLeft[7] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_8 (1).png"));
			this.comboIMGLeft[8] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_9 (1).png"));
			this.comboIMGLeft[9] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_10 (1).png"));
			this.comboIMGLeft[10] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_11 (1).png"));
			this.comboIMGLeft[11] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_12 (1).png"));
			this.comboIMGLeft[12] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_13 (1).png"));
			this.comboIMGLeft[13] = ImageIO
					.read(getClass().getResource("/character/" + characterName + "/combof_14 (1).png"));
